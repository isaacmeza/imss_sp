...
foreach var of varlist lg_afiliados_imss* { 
	...
	*Luminosity (+ quarter of implementation)
	...
	esttab using "$directorio/Tables/reg_results/did_reg_imss.csv", se r2 ${star} b(a2)  replace keep(SP*) scalars("DepVarMean DepVarMean" "num_mun num_mun" "pval_alpha pval_alpha")			
...
foreach var of varlist lg1_emp_cross* lg1_ta_low_wage lg1_ta_high_wage lg1_ta_soltero  lg1_ta_casado /// Cross-IMSS
	...
	*Luminosity (+ quarter of implementation)
	...
	esttab using "$directorio/Tables/reg_results/did_reg_het_cross.csv", se r2 ${star} b(a2)  replace keep(SP*) scalars("DepVarMean DepVarMean" "num_mun num_mun" "pval_alpha pval_alpha")	
...
*-------------------------------------------------------------------------------
	...
	*Luminosity (+ quarter of implementation)
	...
	esttab using "$directorio/Tables/reg_results/did_reg_`var'.csv", se r2 ${star} b(a2)  replace keep(SP*) scalars("DepVarMean DepVarMean" "num_mun num_mun" "pval_alpha pval_alpha")			
